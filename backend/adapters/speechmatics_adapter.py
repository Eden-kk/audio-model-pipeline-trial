...
class SpeechmaticsAdapter:
    ...
    # The Speechmatics streaming endpoint requires an explicit language
    # at session start — there is no "auto" option in this list — so the
    # UX is "pick at start", not realtime auto-detection.

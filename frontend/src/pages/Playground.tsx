      ...
      <div className="flex-1 overflow-auto p-6 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="card flex flex-col gap-4">
            ...
            {selectedMeta && inputMode === 'mic-stream' && langSupport(selectedMeta) === 'single' && (
        ...
        {/* Per-stage language picker — only for upload/record runs.
            mic-stream mode has its own picker inside the adapter card. */}
        {selectedMeta?.multilang && inputMode !== 'mic-stream' && (
          <div className="card flex flex-col gap-4">
